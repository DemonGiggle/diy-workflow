...
export const zhTw: LocaleResources = {
  ...
  ui: {
    ...
    "output.title": "輸出",
    "output.inspectHint": "執行 workflow 或選取已儲存紀錄，以檢視各節點發出的 log。",
    "output.empty": "這次執行在目前等級下沒有可顯示的 log。",
    "output.levelFilter": "Log 等級",
    "output.level.debug": "Debug 以上",
    "output.level.info": "Info 以上",
    "output.level.warn": "Warn 以上",
    "output.level.error": "只看 Error",
    "output.step": "步驟 {stepId}",
    "output.bytes": "{bytes} 位元組",
    ...
    "topbar.fileGroup": "檔案",
    "topbar.moreGroup": "更多",
    "topbar.noRuns": "沒有已儲存的執行紀錄",
    "topbar.runGroup": "執行",
    "topbar.runStatus": "執行狀態",
    "topbar.settings": "設定",
  ...
  actions: {
    ...
    "io.write_stdout": {
      label: "寫入標準輸出",
      description: "將文字或 JSON 相容內容輸出到執行結果面板。",
      inputFields: {
        content: { label: "內容", placeholder: "連接文字，或輸入 JSON 相容內容" },
        label: { label: "標籤", placeholder: "選填的前綴標籤" },
        newline: { label: "結尾換行" },
      },
      configFields: {
        "mock.enabled": { label: "Mock 模式" },
        "mock.content": { label: "Mock 內容" },
        "mock.label": { label: "Mock 標籤", placeholder: "preview" },
        "mock.newline": { label: "Mock 結尾換行" },
        "mock.bytes": { label: "Mock 位元組數" },
      },
      outputFields: {
        content: { label: "內容" },
