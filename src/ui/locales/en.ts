...
export const en: LocaleResources = {
  ...
  ui: {
    ...
    "stdout.title": "Output",
    "stdout.inspectHint": "Run the workflow or select a saved run to inspect stdout-style output emitted by output steps.",
    "stdout.empty": "No stdout output was emitted for this run.",
    "stdout.step": "Step {stepId}",
    "stdout.bytes": "{bytes} bytes",
